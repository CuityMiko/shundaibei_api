...
const siteConfig = require('../config/site_conf'); 

const pool  = mysql.createPool({
    host : siteConfig.mysqlconhost,
    port : siteConfig.mysqlconport,
    user : siteConfig.mysqlusername,
    password : siteConfig.mysqlpwd,
    database : siteConfig.mysqldb
});
